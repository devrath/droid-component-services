        ...
        binding.apply {
            ...
            checkServiceId.setOnClickListener {
                if(NormalDownloadService.isCurrentServiceRunning()){
                    toast(msg = "Service is running",isShort = true, context = this@NormalServiceActivity)
                }else{
                    toast(msg = "Service is not running",isShort = true, context = this@NormalServiceActivity)
                }
            }
